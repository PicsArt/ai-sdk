...
interface MessageToolCallParam {
    id: string;
    type: string;
    function: MessageToolCallFunction;
    extra_content?: Record<string, unknown>;
}
interface MessageToolCallFunction {
    name: string;
...
interface CacheCreationDetails {
...
interface Ltx23TextToVideoResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
    result: LTXV23TextToVideoResponse$1;
}
...
interface Ltx23ImageToVideoResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
    result: LTXV23ImageToVideoResponse$1;
}
...
interface Ltx23TextToVideoFastResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
    result: LTXV23TextToVideoFastResponse$1;
}
...
interface Ltx23ImageToVideoFastResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
    result: LTXV23ImageToVideoFastResponse$1;
}
...
interface MinimaxH3MaxVideoGenerationCommand {
    prompt: string;
...
interface MinimaxH3MaxCameraControlsResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
...
interface CreatifyBorealResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
    result: BorealOutputModel;
}
...
interface MinimaxH3MaxLipSyncImageToVideoResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
...
interface Flux3ImageResult {
    result: Flux3ImageResultBody;
}
interface Flux3ImageResultBody {
...
interface LightricksLtx25TextToVideoProResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
...
interface LightricksLtx25ImageToVideoProResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
...
interface LightricksLtx25TextToVideoFastResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
...
interface LightricksLtx25ImageToVideoFastResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
...
interface MinimaxH3MaxExtendVideoResponse {
    id: string;
    status: "ACCEPTED" | "IN_PROGRESS" | "COMPLETED" | "FAILED";
...
interface WorkflowTypes {
    ...
    'pcp/v1/aifilters': {
        params: AifiltersCommand;
        result: AifiltersResponse;
    };
    ...
    'minimax/h3-max/camera-controls': {
        params: H3MaxMultiAngleInput;
        result: MinimaxH3MaxCameraControlsResponse;
    };
    'ideogram/v4/remix': {
        params: IdeogramV4RemixCommand;
        result: IdeogramV4RemixResponse;
    };
    'creatify/boreal': {
        params: BorealInputModel;
        result: CreatifyBorealResponse;
    };
    'minimax/h3-max/lip-sync/image-to-video': {
        params: LipSyncImageInput;
        result: MinimaxH3MaxLipSyncImageToVideoResponse;
    };
    'bfl/v1/flux-3-image': {
        params: Flux3ImageCommand;
        result: Flux3ImageResult;
    };
    'lightricks/ltx-2.5/text-to-video/pro': {
        params: LTXV25TextToVideoRequest;
        result: LightricksLtx25TextToVideoProResponse;
    };
    'lightricks/ltx-2.5/image-to-video/pro': {
        params: LTXV25ImageToVideoRequest;
        result: LightricksLtx25ImageToVideoProResponse;
    };
    'lightricks/ltx-2.5/text-to-video/fast': {
        params: LTXV25TextToVideoFastRequest;
        result: LightricksLtx25TextToVideoFastResponse;
    };
